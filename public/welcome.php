...
<head>
    ...
    <title>Justin Reich : Welcome</title>
</head>
<body>
        ...
        <div class="container">
          ...
          <div id="navbar" class="collapse navbar-collapse">
            <ul class="nav navbar-nav">
              <li class="active"><a href="/welcome.php" id="expand">Welcome</a></li>
    ...
    <div id="wrap">
        <main class="container fade-in">
            ...
            <p>-Justin Reich</p>
            <img src="img/aardvark-walking.jpg" id="aardvark">
